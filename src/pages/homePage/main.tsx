...
import ScrollText from '../../components/home/scrollText.tsx'
                    ...
                    <div className='relative'>
                        ...
                        <div className='grid grid-cols-10 gap-x-5'>
                            <div className='flex flex-col justify-start gap-y-2 col-span-8  min-w-[800px]'>
                                <img src={HeadingImage} alt='Heading' className='drop-shadow-md z-40 select-none' />
                                <div className='flex flex-col justify-start gap-y-2 '>
                                    <img src={HeadingImageOutline} alt="HeadingOutlined" className='opacity-75 select-none  '></img>
                                    <img src={HeadingImageOutline} alt="HeadingOutlined" className='opacity-50 select-none'></img>
                                    <img src={HeadingImageOutline} alt="HeadingOutlined" className='opacity-25 select-none'></img>
                                </div>
                            </div>
                        </div>
                        {/* Menu */}
                        ...
                        <div className='absolute top-14 right-0 w-2/5'>
                            <img src={Hero} alt='Hero' className='min-w-[400px] h-full z-30 rounded-lg select-none ' />
                        </div>
                    </div>
                </div>
            </div>
